...
namespace Persistence.Migrations
{
    ...
    [Migration("20260728163811_AddItemInventoryLocationMovementHistory")]
    partial class AddItemInventoryLocationMovementHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Bem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("TombamentoFormatado")
                        .IsRequired()
                        .HasMaxLength(120)
                        .HasColumnType("varchar(120)");

                    b.Property<DateTime?>("UltimaConsultaEEstadoEm")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("Domain.Model.ItemInventariado", b =>
                {
                    ...
                    b.Property<bool>("IsVeiculo")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("JustificativaInservivel")
                        .IsRequired()
                        .HasMaxLength(2000)
                    ...
                    b.Property<string>("MotivoUltimaReversaoEEstado")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("varchar(2000)");
                    ...
                    b.Property<string>("PlacaSeguranca")
                        .IsRequired()
                        .HasMaxLength(40)
                        .HasColumnType("varchar(40)");
                    ...
                    b.Property<DateTime?>("RevertidoEEstadoEm")
                        .HasColumnType("datetime(6)");

                    b.Property<Guid?>("RevertidoEEstadoPorUsuarioId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("RevertidoEEstadoPorUsuarioId");
            ...
            modelBuilder.Entity("Domain.Model.ItemInventariadoMovimentacaoLocal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("MovidoPorUsuarioId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("MovidoPorUsuarioId");

                    b.ToTable("ItensInventariadosMovimentacoesLocal", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Model.Local", b =>
                {
                    ...
                    b.Property<Guid?>("LocalSuperiorId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("LocalSuperiorId");

                    b.ToTable("Locais", (string)null);
                });

            modelBuilder.Entity("Domain.Model.LocalMembro", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("LocalId", "UsuarioId")
                        .IsUnique();

                    b.ToTable("LocaisMembros", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Model.ItemInventariado", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Usuario", "ExcluidoPorUsuario")
                        .WithMany()
                    ...
                    b.HasOne("Domain.Model.Usuario", "RevertidoEEstadoPorUsuario")
                        .WithMany()
                        .HasForeignKey("RevertidoEEstadoPorUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("RevertidoEEstadoPorUsuario");
            ...
            modelBuilder.Entity("Domain.Model.ItemInventariadoMovimentacaoLocal", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Local", "LocalOrigem")
                        .WithMany()
                        .HasForeignKey("LocalOrigemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Model.Usuario", "MovidoPorUsuario")
                        .WithMany()
                        .HasForeignKey("MovidoPorUsuarioId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Model.Local", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Local", "LocalSuperior")
                        .WithMany("LocaisSubordinados")
                        .HasForeignKey("LocalSuperiorId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("Comissao");

                    b.Navigation("LocalSuperior");
                });
            ...
            modelBuilder.Entity("Domain.Model.ItemInventariado", b =>
                {
                    ...
                    b.Navigation("MovimentacoesLocal");
                });
            ...
            modelBuilder.Entity("Domain.Model.Local", b =>
                {
                    ...
                    b.Navigation("LocaisSubordinados");
